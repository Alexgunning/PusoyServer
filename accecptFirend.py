...
networkCall = "curl -i -H \"Content-Type: application/json\" -X POST -d '{\"origFriendID\":\"%s\",\"newFriendEmail\":\"%s\"}' http://%s:5000/acceptFriend"%(origFriendID, newFriendEmail, ipAddress)
print(networkCall)
